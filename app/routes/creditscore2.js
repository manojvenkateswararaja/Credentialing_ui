...
export default Route.extend({
    ...
    model(){
        ...
        for(let i=0;i<=len-1;i++){
            ...
            // var statusForGenerated=showrecords[i].Record.statusForGenerated
            // console.log("statusForGenerated>>>>>>>",statusForGenerated)
        }
            var statusForCreditRequest=showrecords.Record.showrecords
