...
export default Controller.extend({
    ...
    payments: Ember.computed('payment', 'extraPrinciple', 'computedDate',function() {
      ...
      while (principle > 0) {
        ...
        payments.push({id: i++, principle, interest, payment, extra, startingPrinciple,principalAmt});
